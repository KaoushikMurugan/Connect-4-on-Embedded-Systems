 ...
 */
function add_connection_establishment_arguments(yargs: any) {
 ...
 */
function add_direct_connection_establishment_arguments(yargs: any) {
    add_universal_arguments(yargs);
    add_common_mqtt_arguments(yargs);
    add_direct_tls_connect_arguments(yargs);
    add_proxy_arguments(yargs);
 ...
 */
function add_universal_arguments(yargs: any) {
    yargs
        .option('verbosity', {
            alias: 'v',
            description:
 ...
 */
function add_common_mqtt_arguments(yargs: any) {
    yargs
        .option('endpoint', {
            alias: 'e',
 ...
 * Proxy arguments
 */
function add_proxy_arguments(yargs: any) {
    yargs
        .option('proxy_host', {
            alias: 'H',
            description:
 ...
 */
function add_topic_message_arguments(yargs: any) {
    yargs
        .option('topic', {
            alias: 't',
 ...
 */
function add_shadow_arguments(yargs: any) {
    yargs
 ...
 */
function add_jobs_arguments(yargs: any) {
    yargs
        .option('thing_name', {
            alias: 'n',
            description: 'The name assigned to your IoT Thing',
 ...
 */
function apply_sample_arguments(argv: any) {
 ...
 */
function build_websocket_mqtt_connection_from_args(argv: any) {
 ...
 */
function build_connection_from_cli_args(argv: any) {
    /*
...
function build_mqtt5_client_from_cli_args(argv: any) {
    /*
     * Only basic websocket and direct mqtt connections for now.  Later add custom authorizer and x509 support.
     */
    if (argv.signing_region) {
