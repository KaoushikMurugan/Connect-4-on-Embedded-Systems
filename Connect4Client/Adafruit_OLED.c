// Ian Chuang and Kaoushik Murugan
...
void writeCommand(unsigned char c) {
    ...
    */
    ...
    unsigned long ulDummy; // dummy var for SPIDataGet

    // Set OLEDCS to low and DC to low, following datasheet
    GPIO_IF_Set(17, GPIOA2_BASE, 0x2, 0); // OLEDCS = OLEDCS_LOW
    GPIO_IF_Set(9, GPIOA1_BASE, 0x2, 0); // DC = DC_LOW
...
void writeData(unsigned char c) {
    ...
    */
    ...
    // Set OLEDCS to low and DC to high, following datasheet
    GPIO_IF_Set(17, GPIOA2_BASE, 0x2, 0); // OLEDCS = OLEDCS_LOW
    GPIO_IF_Set(9, GPIOA1_BASE, 0x2, 1); // DC = DC_HIGH
